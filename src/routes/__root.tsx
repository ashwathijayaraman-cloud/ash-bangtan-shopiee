...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A creative stationery store offering notebooks, pens, pencils, art supplies, craft materials, cute accessories, and unique merchandise. Designed to make shoppin" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Bangtan-shopiee" },
      { property: "og:description", content: "A creative stationery store offering notebooks, pens, pencils, art supplies, craft materials, cute accessories, and unique merchandise. Designed to make shoppin" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Bangtan-shopiee" },
      { name: "twitter:description", content: "A creative stationery store offering notebooks, pens, pencils, art supplies, craft materials, cute accessories, and unique merchandise. Designed to make shoppin" },
